...
<%@ page import="com.smart.dao.ManagerDao"%>
<%@ page import="com.smart.domain.Manager"%>
...
Manager form1=(Manager)managerDAO.query_p((String)session.getAttribute("manager"));
int sysset1=0;
int readerset1=0;
int bookset1=0;
int borrowback1=0;
...
<script src="${path}/JS/onclock.JS"></script>
