...
<%@ page import="com.smart.domain.Parameter" %>
<c:set value="${pageContext.request.contextPath}" var="path" scope="page"/>
<html xmlns="http://www.w3.org/1999/xhtml">
<%
Parameter form=(Parameter)request.getAttribute("parameterModifyif");
int cost=0;
int validity=0;
%>
<head>
...
</table>  <form name="form1" method="post" action="${path}/parameter/parameterModify.html">
<%if(form!=null){
	cost=form.getCost();
