...
<td width="16%" align="right">
      <a href="#" onClick="window.open('${path}/bookCase/getBookCaseAddJsp.html','','width=292,height=175')">添加书架信息</a> </td>
  </tr>
</table>  
...
<%
  while(it.hasNext()){
    BookCase bookCaseForm=(BookCase)it.next();
	ID=bookCaseForm.getId().intValue();
	name=chStr.toChinese(bookCaseForm.getName());
	%> 
  <tr>
    <td style="padding:5px;"><%=name%></td>
    <td align="center"><a href="#" onClick="window.open('${path}/bookCase/bookCaseModifyQuery.html?id=<%=ID%>','','width=292,height=175')">修改</a></td>
    <td align="center"><a href="${path}/bookCase/bookCaseDel.html?id=<%=ID%>">删除</a></td>
  </tr>
<%
  }
}
