...
%>
  ...
  <tr>
    <td>
      <a href="${path}/reader/getReader_addJsp.html">添加读者信息</a> </td>
  </tr>
</table>
 <%
}else{
...
<%
  ...
  <tr>
    ...
    <td align="center"><a href="${path}/reader/readerModifyQuery.html?id=<%=ID%>">修改</a></td>
    <td align="center"><a href="${path}/reader/readerDel.html?id=<%=ID%>">删除</a></td>
  </tr>
<%
  }
}
