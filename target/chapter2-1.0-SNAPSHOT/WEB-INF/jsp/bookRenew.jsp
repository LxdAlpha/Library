...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td align="center" valign="top" style="padding:5px;"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="47" background="${path}/Images/borrowBackRenew_r.gif">&nbsp;</td>
      </tr>
      <tr>
...
%>
				...
				<form name="form1" method="post" action="${path}/borrow/bookrenew.html">
          ...
          <tr>
            <td valign="top"><table width="100%" height="35" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#F6B83B" bgcolor="#FFFFFF">
                <tr align="center" bgcolor="#e3F4F7">
                  ...
                  <td width="12%" bgcolor="#FFF9D9"><input name="Button22" type="button" class="btn_grey" value="完成续借" onClick="window.location.href='${path}/book/getbookRenewjsp.html'"></td>
                </tr>
<%
int id=0;
String bookname="";
...
%>
                   <tr>
                     ...
                     <td width="12%" align="center"><a href="${path}/borrow/bookrenew.html?barcode=<%=barcode%>&id=<%=id%>">续借</a>&nbsp;</td>
                   </tr>
                <%	}
}%>
            </table>
