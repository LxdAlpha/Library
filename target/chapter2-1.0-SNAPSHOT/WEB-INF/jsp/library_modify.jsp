...
<%@ page import="com.smart.domain.Library" %>
<c:set value="${pageContext.request.contextPath}" var="path" scope="page"/>
<html xmlns="http://www.w3.org/1999/xhtml">
<%
Library libraryForm=(Library)request.getAttribute("libraryModifyif");
String libraryname="";
String curator="";
String tel="";
String address="";
...
</table>  <form name="form1" method="post" action="${path}/library/libraryModify.html">
<%
if(libraryForm!=null){
