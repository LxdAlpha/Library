...
<%@ page import="com.smart.domain.BookType" %>
...
%>
  ...
  <tr>
    <td>
      <a href="#" onClick="window.open('${path}/bookType/getBookType_addJsp.html','','width=292,height=175')">添加图书类型信息</a> </td>
  </tr>
</table>
 <%
}else{
...
<%
  while(it.hasNext()){
    BookType bookTypeForm=(BookType)it.next();
  ...
  <tr>
    ...
    <td align="center"><a href="#" onClick="window.open('${path}/bookType/bookTypeModifyQuery.html?id=<%=ID%>','','width=292,height=175')">修改</a></td>
    <td align="center"><a href="${path}/bookType/bookTypeDel.html?id=<%=ID%>">删除</a></td>
  </tr>
<%
  }
}
