    ...
    <td align="center" valign="top" style="padding:5px;"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="57" background="${path}/Images/main_booksort.gif">&nbsp;</td>
          </tr>
          <tr>
            <td height="72" valign="top"><table width="100%" height="63"  border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr align="center">
					...
					<%if(coll_book!=null && !coll_book.isEmpty()){
					  ...
					  Float price=new Float(0);
						  ...
						  Borrow borrowForm=(Borrow)it_book.next();
              ...
              <tr>
                <td height="30" align="right" valign="middle"><a href="${path}/borrow/bookBorrowSort.html"><img src="${path}/Images/more.GIF" width="50" height="20" border="0">&nbsp;</a></td>
              </tr>
            </table></td>
          </tr>
        </table>
