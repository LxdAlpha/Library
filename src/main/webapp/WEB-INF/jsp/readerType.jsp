...
%>
  ...
  <tr>
    <td>
      <a href="#" onClick="window.open('${path}/readerType/getReaderType_add.html','','width=292,height=175')">添加读者类型信息</a> </td>
  </tr>
</table>
 <%
}else{
...
<%
  ...
  <tr>
    ...
    <td align="center"><a href="#" onClick="window.open('${path}/readerType/readerTypeModifyQuery.html?id=<%=ID%>','','width=292,height=175')">修改</a></td>
    <td align="center"><a href="${path}/readerType/readerTypeDel.html?id=<%=ID%>">删除</a></td>
  </tr>
<%
  }
}
