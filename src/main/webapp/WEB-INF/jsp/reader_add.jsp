...
<c:set value="${pageContext.request.contextPath}" scope="page" var="path"/>
...
ReaderTypeDao readerTypeDAO= (ReaderTypeDao) ctx1.getBean("ReaderTypeDao");
String str=null;
...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
	...
	<form name="form1" method="post" action="${path}/reader/readerAdd.html">
