...
<%@ page import="com.smart.dao.BorrowDao"%>
...
<%
  while(it.hasNext()){
	...
	bookname=chStr.toChinese(borrow.getBookName());
        barcode_book=borrow.getBookBarcode();
        typename=chStr.toChinese(borrow.getBookType());
	degree=borrow.getDegree();
	bookcase=chStr.toChinese(borrow.getBookcaseName());
        pub=chStr.toChinese(borrow.getPubName());
        author=chStr.toChinese(borrow.getAuthor());
        price=borrow.getPrice();
	%>
  <tr>
