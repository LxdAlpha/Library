...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    ...
    <form name="form1" method="post" action="${path}/borrow/bookborrow.html">
     <table width="100%"  border="0" cellspacing="0" cellpadding="0">
	 <tr>
        <td height="47" background="${path}/Images/borrowBackRenew.gif">&nbsp;</td>
      </tr>
      <tr>
        <td height="72" align="center" valign="top" background="${path}/Images/main_booksort_1.gif" bgcolor="#F8BF73"><table width="96%" border="0" cellpadding="1" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#F8BF73">
          <tr>
...
%>
               ...
               <tr>
                 <td height="32" background="${path}/Images/borrow_if.gif">&nbsp;添加的依据：
...
<input name="inputkey" type="text" id="inputkey" size="50">
  ...
  <input name="Button" type="button" class="btn_grey" value="完成借阅" onClick="window.location.href='${path}/book/getbookBorrowjsp.html'">
                   </td>
               </tr> 
          <tr>
